...
import { CommonServiceIds, getClient, IProjectPageService, IVssRestClientOptions } from "azure-devops-extension-api";
...
export async function initializeRepository(repository: GitRepository, createReadme: boolean, gitignoreTemplate?: string): Promise<void> {
    let comment = [];
    let gitChange = [];
